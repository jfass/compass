...
system "nucmer compassRun.TEMP.ref compassRun.TEMP.contigs > nucmer.log";
...
system "delta-filter -q out.delta > out.filter";
...
# system "Rscript graph.R &> $fnGoo.log";
system "Rscript ./graph.R $opt_x $opt_y &> compassRun.TEMP.log";
